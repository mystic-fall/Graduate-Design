...
function initLiveData() {
    ...
    $.ajax({
        ...
        success: function (data) {
            contentLiveData = data.data.liveList;
...
function addStudentAndDormitoryData(contentLiveData) {
    ...
    $.ajax({
        ...
        success: function (data) {
            var studentData = data.data.stuList;
            $.ajax({
                async: false,
                cache: false,
                type: 'GET',
                ...
                accept: "application/json;charset=UTF-8",
                contentType: "application/json;charset=UTF-8",
                url: 'http://localhost:3000/api/v1/dormitory',
                headers: {
                    "Authorization": token
                },
                success: function (data) {
                    var dormitoryData = data.data.dormitoryList;
...
function liveAdd() {
    ...
    $.ajax({
        ...
        success: function (data) {
            selectStudentData = data.data.stuList;
    ...
    $.ajax({
        ...
        success: function (data) {
            selectDormitoryData = data.data.dormitoryList;
...
function liveDelete(id) {
    ...
    $.ajax({
        ...
        accept: "application/json;charset=UTF-8",
        contentType: "application/json;charset=UTF-8",
        url: 'http://localhost:3000/api/v1/live?id=' + id,
        headers: {
            "Authorization": token
        },
        success: function (data) {
...
function liveUpload() {
    ...
    $.ajax({
        url: 'http://localhost:3000/api/v1/upload?table=live',
        headers: {
            "Authorization": token
        },
        type: 'POST',
