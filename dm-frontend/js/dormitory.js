...
function initDormitoryData() {
    ...
    $.ajax({
        ...
        success: function (data) {
            contentDormitoryData = data.data.dormitoryList;
...
function addBuildingData(contentDormitoryData){
    ...
    $.ajax({
        ...
        success: function (data) {
            var buildingData = data.data.buildingList;
...
function dormitoryQuery() {
    ...
    if (isNull(dormitorySn)) {
        ...
        $.ajax({
            ...
            accept: "application/json;charset=UTF-8",
            contentType: "application/json;charset=UTF-8",
            url: 'http://localhost:3000/api/v1/dormitory?sn=' + dormitorySn,
            headers: {
                "Authorization": token
            },
            success: function (data) {
...
function dormitoryAdd() {
    ...
    $.ajax({
        ...
        success: function (data) {
            contentData = data.data.buildingList;
...
function dormitoryDelete(id) {
    ...
    $.ajax({
        ...
        accept: "application/json;charset=UTF-8",
        contentType: "application/json;charset=UTF-8",
        url: 'http://localhost:3000/api/v1/dormitory?id=' + id,
        headers: {
            "Authorization": token
        },
        success: function (data) {
...
function dormitoryUpload() {
    ...
    $.ajax({
        url: 'http://localhost:3000/api/v1/upload?table=dormitory',
        headers: {
            "Authorization": token
        },
        type: 'POST',
